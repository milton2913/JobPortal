<div class="form-group col-md-4 {{ $errors->has('title') ? 'has-error' : ''}}">
    ...
    {!! Form::text('title', null, ['class' => 'form-control', 'id'=>'title', 'required' => 'required','placeholder'=>'Subject Title']) !!}
    {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group col-md-4 {{ $errors->has('slug') ? 'has-error' : ''}}">
    <label class="control-label">Subject  slug/url</label>
    {!! Form::text('slug', null, ['class' => 'form-control',  'id'=>'slug', 'required' => 'required','placeholder'=>'Subject slug']) !!}
